...
export default function DiagnosisResult() {
  ...
  return (
    ...
    >
      ...
      {/* Image if available */}
      {(result.imageUrl || result.imageUri) && (
        <View style={styles.imageCard}>
          <Text style={styles.sectionTitle}>Analyzed Image</Text>
          <Image
            source={{ uri: result.imageUrl || result.imageUri }}
            style={styles.image}
            resizeMode="cover"
          />
        </View>
      ...
      <View style={styles.warningBanner}>
        ...
        <Text style={styles.warningText}>
          This is a preliminary diagnosis. Always consult a qualified
